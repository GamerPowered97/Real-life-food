...
public class ModFoodComponents {
    ...
    public static final FoodComponent FROSTING = new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 100, 1), 1.0f).build();
    public static final FoodComponent DOUGH = new FoodComponent.Builder().hunger(2).saturationModifier(0f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 10, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 10, 1), 1.0f).build();
}
